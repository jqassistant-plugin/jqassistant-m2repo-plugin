 ...
 * @author pherklotz
 */
@Label(value = "Release", usingIndexedPropertyOf = FullQualifiedNameDescriptor.class)
public interface MavenReleaseDescriptor extends MavenDescriptor, ArtifactInfoDescriptor {
}
